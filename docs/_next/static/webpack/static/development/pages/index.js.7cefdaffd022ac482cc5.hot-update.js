...
class Home extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isResult: false,
      fetchData: false,
      list: ['garvo girnar', 'saiyam kyare malse', 'saiyam sachu che', 'gaaje re aaje'] // this.fetchList();
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      ...
      __self: this
    }, "Search"))), value ? filteredList.map(name => {
      return name;
...
//# sourceMappingURL=index.js.7cefdaffd022ac482cc5.hot-update.js.map